...
{
    ASSERT_NO_THROW(SMath::Point3 p);
}
...
{
    EXPECT_EQ(SMath::Point3(1.0), SMath::Point3(1.0));
    EXPECT_EQ(SMath::Point3(0.2), SMath::Point3(0.2));
    EXPECT_EQ(SMath::Point3(1.0, 2.0, 3.0), SMath::Point3(1.0, 2.0, 3.0));
    EXPECT_NE(SMath::Point3(0.0), SMath::Point3(1.0));
    EXPECT_NE(SMath::Point3(0.0), SMath::Point3(0.00001));
    EXPECT_NE(SMath::Point3(0.0, 1.0, 2.0), SMath::Point3(0.0, 1.0, 2.1));
}
...
{
    EXPECT_DOUBLE_EQ(SMath::Point3::Distance({ 0, 0, 0 }, { 1.0, 0.0, 0.0 }), 1.0);
    EXPECT_DOUBLE_EQ(SMath::Point3::SquareDistance({ 0, 0, 0 }, { 1.0, 0.0, 0.0 }), 1.0);
    EXPECT_DOUBLE_EQ(SMath::Point3::Distance({ 0.5, 0.13, -3.24 }, { 1.23, -4.04, 2.1 }), 6.8144992479271727);
    EXPECT_DOUBLE_EQ(SMath::Point3::SquareDistance({ 0.5, 0.13, -3.24 }, { 1.23, -4.04, 2.1 }), 46.437399999999997);
}
